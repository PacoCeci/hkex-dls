...
function SvgCameraSwapFilled(props: ISvgProps) {
    ...
    <span className="hecl-icon">
      {
        ...
        >
          <path
            fill="currentColor"
            d="M14 11.698c0-1.102.898-2 2-2 1.102 0 2 .898 2 2 0 1.102-.898 2-2 2-1.102 0-2-.898-2-2Z"
          />
          <path
            fill="currentColor"
            fillRule="evenodd"
            d="M13.293 3.491A1 1 0 0 1 14 3.198h4a1 1 0 0 1 .707.293l1.707 1.707H23a3 3 0 0 1 3 3v8a3 3 0 0 1-3 3H9a3 3 0 0 1-3-3v-8a3 3 0 0 1 3-3h2.586l1.707-1.707ZM16 7.698c-2.207 0-4 1.794-4 4 0 2.207 1.794 4 4 4s4-1.794 4-4-1.793-4-4-4Z"
            clipRule="evenodd"
          />
          <path
            fill="currentColor"
...
SvgCameraSwapFilled.propTypes = propTypes;
SvgCameraSwapFilled.defaultProps = defaultProps;
export default SvgCameraSwapFilled;
