...
function SvgCallIncomingOutlined(props: ISvgProps) {
    ...
    <span className="hecl-icon">
      {
        ...
        >
          <path
            fill="currentColor"
            d="M26 14.198h-7a1 1 0 0 1-1-1v-7a1 1 0 1 1 2 0v4.586l7.293-7.293a1 1 0 1 1 1.414 1.414l-7.293 7.293H26a1 1 0 1 1 0 2Z"
          />
          <path
            fill="currentColor"
            fillRule="evenodd"
...
SvgCallIncomingOutlined.propTypes = propTypes;
SvgCallIncomingOutlined.defaultProps = defaultProps;
export default SvgCallIncomingOutlined;
