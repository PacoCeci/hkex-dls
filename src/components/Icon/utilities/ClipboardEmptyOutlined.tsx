...
function SvgClipboardEmptyOutlined(props: ISvgProps) {
...
SvgClipboardEmptyOutlined.propTypes = propTypes;
SvgClipboardEmptyOutlined.defaultProps = defaultProps;
export default SvgClipboardEmptyOutlined;
