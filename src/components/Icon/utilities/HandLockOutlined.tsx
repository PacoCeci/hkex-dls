...
function SvgHandLockOutlined(props: ISvgProps) {
    ...
    <span className="hecl-icon">
      {
        ...
        >
          <path
            fill="currentColor"
            fillRule="evenodd"
            d="M16 10.198a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v7a2 2 0 0 1-2 2H18a2 2 0 0 1-2-2v-7Zm12 0H18v7h10v-7Z"
            clipRule="evenodd"
          />
          <path
            fill="currentColor"
...
SvgHandLockOutlined.propTypes = propTypes;
SvgHandLockOutlined.defaultProps = defaultProps;
export default SvgHandLockOutlined;
