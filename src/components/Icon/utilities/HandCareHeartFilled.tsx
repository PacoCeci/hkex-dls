...
function SvgHandCareHeartFilled(props: ISvgProps) {
...
SvgHandCareHeartFilled.propTypes = propTypes;
SvgHandCareHeartFilled.defaultProps = defaultProps;
export default SvgHandCareHeartFilled;
