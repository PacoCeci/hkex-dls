...
function SvgZoomInOutlined(props: ISvgProps) {
    ...
    <span className="hecl-icon">
      {
        ...
        >
          <path
            fill="currentColor"
            d="M20 15.198a1 1 0 0 1-1 1h-3v3a1 1 0 1 1-2 0v-3h-3a1 1 0 1 1 0-2h3v-3a1 1 0 1 1 2 0v3h3a1 1 0 0 1 1 1Z"
          />
          <path
            fill="currentColor"
            fillRule="evenodd"
...
SvgZoomInOutlined.propTypes = propTypes;
SvgZoomInOutlined.defaultProps = defaultProps;
export default SvgZoomInOutlined;
