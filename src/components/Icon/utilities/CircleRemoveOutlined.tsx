...
function SvgCircleRemoveOutlined(props: ISvgProps) {
...
SvgCircleRemoveOutlined.propTypes = propTypes;
SvgCircleRemoveOutlined.defaultProps = defaultProps;
export default SvgCircleRemoveOutlined;
