...
function SvgUserLockOutlined(props: ISvgProps) {
...
SvgUserLockOutlined.propTypes = propTypes;
SvgUserLockOutlined.defaultProps = defaultProps;
export default SvgUserLockOutlined;
